...
{
    public class MacOS : OS.IBackend
    {
        ...
        public async Task Start(string[] args)
        {
            ...
            if (args.Any())
            {
                ...
                if (!await Update(args) || !File.Exists($"{Program.Name}.app"))
                    return;
            ...
            else
            {
                ...
                Process.Start(new ProcessStartInfo(Path.Combine(tempDir, "dotnet Updater")) { Arguments = Directory.GetCurrentDirectory() });
            }
        }
